...
eqtl_step2.py <geno.hdf5> <pheno.filtered.hdf5> <corr_method> <hdf_correction> <Kpop.hdf5> <covariates.hdf5> <cis_window> <n_perm> <alpha> <flanking> <list_fold_j> <summary.gz> <metainfo.tsv> '''
...
if __name__=='__main__':
	...
	summary = gzip.open(sys.argv[12],'wb') #outfile
	...
	#set flanking value to default (False). This argument is not used from now on, although it may have been set to True in the association analysis step.
